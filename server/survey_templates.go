                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0" style="padding: 20px 50px 0; text-align: center; margin: 0 auto">
                                        <tr>
                                            <td style="padding: 0 0 20px;">
                                                ...
                                                <p><a href="{{.SiteURL}}/admin_console/integrations/{{.PluginID}}">Click here</a> to disable or learn more about Net Promoter surveys.</p>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td style="padding: 0 0 20px;">
...
[Click here](/admin_console/integrations/%s) to disable or learn more about Net Promoter Score Surveys.
